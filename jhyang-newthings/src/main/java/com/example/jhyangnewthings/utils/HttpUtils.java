...
public class HttpUtils {
    ...
    public static void main(String[] args) {
        String url = "http://localhost:9200/crm/_search";
        String param = "{\n" +
                "    \"query\": {\n" +
                "     \"query_string\": {\n" +
                "       \"query\": \"杨\"\n" +
        ...
        jsonObject1.put("query","杨");
        jsonObject2.put("query_string",jsonObject1);
        jsonObject3.put("query", jsonObject2);


        String result = HttpUtils.postRequest(url, jsonObject3);
